...
class Bunyad_BbpLogin_Widget extends WP_Widget {
	...
	public function widget( $args = array(), $instance = array() ) {
		...
		if (!is_user_logged_in()) : ?>
				...
				<fieldset>
					...
					<div class="bbp-username input-group">
						...
						<input type="text" name="log" value="<?php bbp_sanitize_val( 'user_login', 'text' ); ?>" size="20" id="user_login" tabindex="<?php bbp_tab_index(); ?>" 
							placeholder="<?php esc_attr_e('Your Username', 'bbPress', 'bunyad-widgets'); ?>" />
					</div>
					...
					<div class="bbp-password input-group">
						...
						<input type="password" name="pwd" value="<?php bbp_sanitize_val( 'user_pass', 'password' ); ?>" size="20" id="user_pass" tabindex="<?php bbp_tab_index(); ?>" 
							placeholder="<?php esc_attr_e('Your Password', 'bbPress', 'bunyad-widgets'); ?>"/>
					</div>
			...
			<div class="bbp-register-info"><?php _e("Don't have an account?", 'bbPress', 'bunyad-widgets'); ?>
				<a href="<?php echo esc_url( $settings['register'] ); ?>" class="register-modal"><?php _e('Register Now!', 'bbPress', 'bunyad-widgets'); ?></a>
			</div>
		...
		<?php else : ?>
			...
			<div class="bbp-logged-in">
				...
				<?php _e('Welcome back, ', 'bbPress', 'bunyad-widgets'); ?>
