		...
		<form method="post" action="options.php">
				...
				<tr valign="top">
					...
					<td>
						<select id="default_activation_behavior" name="tps_advanced[default_activation_behavior]">
							<option value="1" <?php echo $options['default_activation_behavior'] == 1 ? 'selected' : ''; ?>>Enable by default on all posts</option>
							<option value="0" <?php echo $options['default_activation_behavior'] == 0 ? 'selected' : ''; ?>>Disable by default on all posts</option>
						</select>
						<p class="description">
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td>
						<label>
							<input type="radio" name="tps_advanced[slide_loading_mechanism]" value="ajax" <?php echo $options['slide_loading_mechanism'] == 'ajax' ? 'checked' : ''; ?>>
						...
						<br>
						<label>
							<input type="radio" name="tps_advanced[slide_loading_mechanism]" value="refresh" <?php echo $options['slide_loading_mechanism'] == 'refresh' ? 'checked' : ''; ?>>
						...
						<br>
						<label>
							<input type="radio" name="tps_advanced[slide_loading_mechanism]" value="all" <?php echo $options['slide_loading_mechanism'] == 'all' ? 'checked' : ''; ?>>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td>
						<label>
							<input type="checkbox" id="tps_refresh_ads" name="tps_advanced[refresh_ads]" onchange="updateAdRefreshing()" value="true" <?php echo $options['refresh_ads'] ? 'checked' : ''; ?>>
				...
				<tr valign="top">
					...
					<td>
						<input type="text" id="tps_refresh_ads_every_n_slides" name="tps_advanced[refresh_ads_every_n_slides]" value="<?php echo $options['refresh_ads_every_n_slides']; ?>">
						<p class="description">
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td>
						<label>
							<input type="checkbox" id="tps_do_not_check_for_multiple_instances" name="tps_advanced[do_not_check_for_multiple_instances]" value="true" <?php echo $options['do_not_check_for_multiple_instances'] ? 'checked' : ''; ?>>
